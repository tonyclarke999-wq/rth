...
config.LinkBrowserURL = config.BasePath + "filemanager/browse/sample_php/browse_01.php" ;
...
//config.LinkUploadURL = config.BasePath + "filemanager/upload/aspx/upload.aspx" ;  //rt 20040809
...
config.LinkUploadWindowHeight	= 250 ;
