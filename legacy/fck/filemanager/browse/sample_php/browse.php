...
//	$IMAGES_BASE_DIR = getenv("DOCUMENT_ROOT").$IMAGES_BASE_URL;
	...
	$IMAGES_BASE_URL = "/tms/userimages/";
	#$UPLOAD_BASE_DIR = getenv("DOCUMENT_ROOT").$UPLOAD_BASE_URL;
	$IMAGES_BASE_DIR = 'c:\\inetpub\\wwwroot' . $IMAGES_BASE_URL;
	#$IMAGES_BASE_DIR = '' . $IMAGES_BASE_URL;
...
function CheckImgExt($filename) {
	$img_exts = array("gif","jpg", "jpeg","png", "bmp", "doc", "xls", "txt", "rtf", "pdf");
